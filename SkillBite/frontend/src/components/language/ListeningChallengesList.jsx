...
import { Ear, Music, Headphones, ChevronLeft, ChevronDown } from 'lucide-react';
import { LISTENING_CHALLENGES } from '../../data/listeningData';
...
export default function ListeningChallengesList({ onSelectChallenge, onBack }) {
  return (
    <div className="pt-2 space-y-6 animate-fade-in">
      ...
      <div className="flex justify-between items-center px-1">
        <div className="flex items-center gap-2">
          <span className="text-sm font-bold text-gray-400">0 / 3 done</span>
        </div>
      ...
      <div className="space-y-3">
        {LISTENING_CHALLENGES.map((challenge) => {
