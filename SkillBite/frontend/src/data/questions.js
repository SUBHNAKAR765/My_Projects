export const SKILL_CATEGORIES = [
  ...
  { id: 'webdev',      title: 'Web/App Dev',       sub: 'Frontend & backend',    emoji: '🌐', icon: 'Globe', bg: 'rgba(6,182,212,0.22)' },
  ...
  { id: 'cooking',     title: 'Cooking',           sub: 'Recipes & techniques',  emoji: '🍳', icon: 'ChefHat', bg: 'rgba(251,146,60,0.22)' },
]
